...
void printcut(Abc_Ntk_t* pNtK, int cut_size)
{
    ...
    vector<pair<Abc_Obj_t*,vector<set<Abc_Obj_t*>>>> sol_out{cut_list.begin(), cut_list.end()};
    sort(sol_out.begin(), sol_out.end(), [](pair<Abc_Obj_t*,vector<set<Abc_Obj_t*>>> a , pair<Abc_Obj_t*,vector<set<Abc_Obj_t*>>> b)
    {
