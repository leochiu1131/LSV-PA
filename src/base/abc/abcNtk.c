...
Abc_Ntk_t *Abc_NtkDup(Abc_Ntk_t *pNtk)
{
    ...
    else
    {
        ...
        if (pNtk->vOrigNodeIds)
        {
            ...
            Abc_NtkForEachObj(pNtk, pObj, i) if (pObj->pCopy && Vec_IntEntry(pNtk->vOrigNodeIds, pObj->Id) > 0)
...
Abc_Ntk_t *Abc_NtkCreateFromRange(Abc_Ntk_t *pNtk)
{
    ...
    Gia_Man_t *p = Abc_NtkClpGia(pNtk);
    int i;
